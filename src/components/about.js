...
<section id="about-container">
  ...
  <p>I’m an experienced Full Stack Web Developer with a strong background in design. I'm interested in crafting responsive web experiences, solving business problems with code, improving web accessibility and usability, and helping marketing and development teams operate more efficiently. Check out <a href="https://www.linkedin.com/in/asuratte" target="_blank" rel="noopener noreferrer" title="LinkedIn">my LinkedIn profile</a> for a full list of my work experience and areas of expertise. You can find code samples on <a href="https://github.com/asuratte" target="_blank" rel="noopener noreferrer" title="GitHub">GitHub</a> and <a href="https://codepen.io/asuratte/collections/public" target="_blank" rel="noopener noreferrer" title="CodePen">CodePen.</a></p>
  <p>I recently earned a Master of Science in Applied Computer Science from the University of West Georgia. When I’m not working or studying, I enjoy spending time outside, watching Star Trek, baking muffins, and looking at pictures of cats on the internet. I live in Woodstock, IL with my husband, Kyle, and our cat, Sprocket.</p>
  </div>
</div>
</section>
);
